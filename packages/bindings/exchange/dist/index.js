...
export class Client extends ContractClient {
    ...
    constructor(options) {
        super(new ContractSpec(["",
    ...
    fromJSON = {
        ...
        order: (this.txFromJSON),
        fee_to: (this.txFromJSON),
        orders: (this.txFromJSON),
        rewards: (this.txFromJSON),
        upgrade: (this.txFromJSON),
        max_rate: (this.txFromJSON),
        min_rate: (this.txFromJSON),
        operator: (this.txFromJSON),
        registry: (this.txFromJSON),
        add_order: (this.txFromJSON),
        available: (this.txFromJSON),
        swap_order: (this.txFromJSON),
        close_order: (this.txFromJSON),
        ...
        close_order_by: (this.txFromJSON),
